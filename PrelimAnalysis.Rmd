...
```{r}
# add description from data dictionary
...
data_dict <- data_dict %>%
  mutate(`Variable name` = ifelse(`Variable name` == "NTproBNP_peri_highest", 
                                  "n_tpro_bnp_peri_highest", `Variable name`))


missing_summary <- missing_summary %>%
  rename(`Variable name` = variable) %>%
  left_join(data_dict %>% select(`Variable name`, Definition), by = "Variable name")
