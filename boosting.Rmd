...
# ------------------------
# STEP 5–6: Impute missing values (only columns that have missing)
# ------------------------
...
# ------------------------
# STEP 8: Define survival time and event
# ------------------------
...
# ------------------------
# STEP 10: Save survival-ready data
# ------------------------
...
```{r}
# ------------------------
# STEP 11: Survival Boosting with GBM
# ------------------------

# Read your cleaned survival data
data <- read_fst("C:\\Users\\johny\\OneDrive\\Desktop\\competition\\data_survival_ready_final.fst", as.data.table = TRUE)
...
# Prepare a data.frame for gbm (must be regular data.frame, not data.table)
boost_data <- as.data.frame(data[, c("time_afib", "event_afib", predictor_vars), with = FALSE])

# Fit gradient boosting Cox model
set.seed(123)
gbm_fit <- gbm(
